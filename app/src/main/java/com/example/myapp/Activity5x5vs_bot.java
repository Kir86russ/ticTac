...
public class Activity5x5vs_bot extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        playField = new PlayField(this, PlayField.InfoAboutGrid._5x5_bot, cX, cO); // vs bot (5x5)
    ...
    private int[] arrX = new int[25];
    private int[] arrY = new int[25];
    private int[] arrTicOrTac = new int[25];
